...
namespace Boring
{
    ...
    public struct Date : IEquatable<Date>, IComparable<Date>, IComparable, IFormattable, IXmlSerializable
    {
        ...
        /// <item>
        ///   <term>Less than zero</term>
        ///   <term>This instance is earlier than <paramref name="other"/>.</term>
        /// </item>
        /// <item>
        ///   <term>Zero</term>
        ///   <term>This instance is the same as <paramref name="other"/>.</term>
        /// </item>
        /// <item>
        ///   <term>Greater than zero</term>
        ///   <term>This instance is later than <paramref name="other"/>.</term>
        /// </item>
        /// </list>
        /// </returns>
        ...
        /// <item>
        ///   <term>Less than zero</term>
        ///   <term>This instance is earlier than <paramref name="obj"/>.</term>
        /// </item>
        /// <item>
        ///   <term>Zero</term>
        ///   <term>This instance is earlier than <paramref name="obj"/>.</term>
        ...
        ///     or <paramref name="obj"/> is <c>null</c>.
        ///   </term>
        /// </item>
        /// </list>
        /// </returns>
        /// <exception cref="ArgumentException">
        /// <paramref name="obj"/> is not a <see cref="Date"/>.
        /// </exception>
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is Date))
            {
                throw new ArgumentException(Strings.Argument_MustBeDate, nameof(obj));
            }
        ...
        /// </summary>
        /// <param name="other">The other <see cref="Date"/> object to compare against this instance.</param>
        /// <returns>
        /// <c>true</c> if the <paramref name="other"/> parameter equals the value of this instance;
        /// otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is an instance of <see cref="Date"/>
        ...
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// The date is outside the range of dates supported by the calendar used by <paramref name="formatProvider"/>.
        /// </exception>
