...
namespace Boring
{
    ...
    public struct Time : IEquatable<Time>, IComparable<Time>, IComparable, IFormattable, IXmlSerializable
    {
        ...
        /// <paramref name="obj"/> is not a <see cref="Time"/>.
        /// </exception>
        ...
        /// </summary>
        /// <param name="other">The other <see cref="Time"/> object to compare against this instance.</param>
        /// <returns>
        ...
        /// <returns>
        /// <c>true</c> if <paramref name="obj"/> is an instance of <see cref="Time"/>
